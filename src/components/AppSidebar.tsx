...
import {
  ...
  ChevronDown, ChevronRight, ChevronLeft, Users,
...
export default function AppSidebar() {
  ...
  return (
    <div className={`${collapsed ? 'w-16' : 'w-56'} h-screen bg-navy flex flex-col border-r border-navy-lighter flex-shrink-0 transition-[width] duration-200`}>
        ...
        <div className="relative">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              {!collapsed && <span className="text-[11px] whitespace-nowrap">{personaOptions.find(p => p.value === persona)?.label}</span>}
            </div>
