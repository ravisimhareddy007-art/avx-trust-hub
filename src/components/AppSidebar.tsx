...
export default function AppSidebar() {
  ...
  return (
    <div className="group absolute z-40 top-0 left-0 h-screen w-16 hover:w-56 transition-[width] duration-200 bg-navy flex flex-col border-r border-navy-lighter overflow-hidden">
