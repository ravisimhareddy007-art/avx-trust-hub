...
const rows: FailedRow[] = [
  ...
  { cert: 'vault.internal.acmecorp.com', ca: 'Internal PKIaaS', reason: 'DNS validation failed', asset: 'vault-server', failedAt: '4h ago', severity: 'High' },
...
const CA_OPTIONS = ['DigiCert', 'Entrust', "Let's Encrypt", 'MSCA Enterprise', 'Internal PKIaaS'] as const;
