...
const TOOLS_DATA: {
  ...
  { id: 't10', name: 'list_ssh_keys', title: 'List SSH Keys', module: 'SSH', tier: 'T1', status: 'degraded', description: 'Returns a paginated list of SSH keys in the tenant inventory filtered by host, user, or risk status.', scope: 'avx:read', version: 'v1.0', readOnly: true, destructive: false, approvalRequired: false, registeredBy: 'sanjay.k@appviewx.com', registeredAt: '2026-03-28', invocations: 620, approvalWorkflowRef: '', rollbackAction: '', maskingList: [], versions: [{ version: 'v1.0', date: '2026-03-28', note: 'Initial release' }] },
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-red-400/5 border border-red-400/20 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-[12px] font-semibold text-foreground">Degraded tool — <span className="font-mono">list_ssh_keys</span></p>
          <p className="text-[10px] text-muted-foreground mt-0.5">SSH API unreachable for 14 minutes. Alert sent to sanjay.k@appviewx.com. Invocations return structured MCP error.</p>
        </div>
      </div>
