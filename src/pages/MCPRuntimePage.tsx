...
const TOOLS_DATA: {
  ...
  { id: 't1', name: 'list_certificates', title: 'List Certificates', module: 'CLM', tier: 'T1', status: 'published', description: 'Returns a paginated list of certificates in the tenant inventory, filtered by status, expiry window, or CA.', scope: 'avx:read', version: 'v1.2', readOnly: true, destructive: false, approvalRequired: false, registeredBy: 'priya.m@appviewx.com', registeredAt: '2026-03-12', invocations: 4821, approvalWorkflowRef: '', rollbackAction: '', maskingList: [], versions: [{ version: 'v1.2', date: '2026-04-10', note: 'Added expiry_window filter param' }, { version: 'v1.0', date: '2026-03-12', note: 'Initial release' }] },
  ...
  { id: 't4', name: 'get_pqc_posture', title: 'Get PQC Posture', module: 'CLM', tier: 'T2', status: 'degraded', description: 'Returns quantum vulnerability assessment for the tenant inventory, including algorithm distribution and migration wave assignments.', scope: 'avx:read', version: 'v1.0', readOnly: true, destructive: false, approvalRequired: false, registeredBy: 'ravi.r@appviewx.com', registeredAt: '2026-04-15', invocations: 742, approvalWorkflowRef: '', rollbackAction: '', maskingList: [], versions: [{ version: 'v1.0', date: '2026-04-15', note: 'Initial release' }] },
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-red-400/5 border border-red-400/20 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <p className="text-[12px] font-semibold text-foreground">Degraded tool — <span className="font-mono">get_pqc_posture</span></p>
          <p className="text-[10px] text-muted-foreground mt-0.5">PQC assessment API unreachable for 14 minutes. Alert sent to priya.m@appviewx.com. Invocations return structured MCP error.</p>
        </div>
      </div>
