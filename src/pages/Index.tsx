...
import { LicensingProvider } from "@/context/LicensingContext";
...
function PageRouter() {
  ...
  return <div className="flex-1 overflow-auto p-6 scrollbar-thin">{pages[currentPage] || <DashboardPage />}</div>;
}
