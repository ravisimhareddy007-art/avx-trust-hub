...
export const VIOLATION_FILTERS: Record<string, DashboardFilter> = {
  ...
  secret_exposed_code: {
    ...
    countNoun: 'secrets',
    predicate: (a) => a.type === 'API Key / Secret' && !!a.tags?.includes('code-exposed'),
  ...
  ai_no_sponsor: {
    ...
    countNoun: 'AI tokens',
    predicate: (a) => a.type === 'AI Agent Token' && a.owner === 'Unassigned',
  ...
  ai_no_rotation_policy: {
    ...
    countNoun: 'AI tokens',
    predicate: (a) => a.type === 'AI Agent Token' && a.rotationFrequency === 'Never',
