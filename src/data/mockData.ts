...
export const mockAssets: CryptoAsset[] = [
  ...
  { id: 'ssh-001', name: 'prod-db-01-authorized-key', type: 'SSH Key', commonName: 'prod-db-01.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:nThbg6kXUp...', owner: 'Unassigned', team: 'Database Operations', application: 'PostgreSQL Primary', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2025-06-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-06-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'Critical', policyViolations: 2, dependencyCount: 1, tags: ['database', 'orphaned', 'suspicious'], sshEndpoints: [{ host: 'prod-db-01.internal', ip: '10.2.14.55', port: 5432, role: 'host', lastSeen: '2026-04-14 08:12' }, { host: 'app-server-03.internal', ip: '10.2.14.20', port: 22, role: 'client', lastSeen: '2026-04-14 08:10' }, { host: 'bastion-01.acmecorp.com', ip: '52.14.88.201', port: 22, role: 'client', lastSeen: '2026-04-13 22:45' }] },
  ...
  { id: 'ssh-005', name: 'gitlab-deploy-key', type: 'SSH Key', commonName: 'gitlab-runner-01', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Wz4kL9pMnO...', owner: 'Unassigned', team: 'DevOps', application: 'GitLab CI', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'Endpoint Agent', issueDate: '2025-03-15', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-03-15', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'Critical', policyViolations: 3, dependencyCount: 2, tags: ['orphaned', 'ci-cd', 'rogue'] },
  ...
  { id: 'secret-002', name: 'aws-iam-access-key-legacy', type: 'API Key / Secret', commonName: 'AKIA...EXAMPLE', caIssuer: 'AWS IAM', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'AKIAIOSFODNN7EXAMPLE', owner: 'Unassigned', team: 'IT Operations', application: 'Legacy Migration Tool', environment: 'Production', infrastructure: 'aws-iam', discoverySource: 'Source Code Scan', issueDate: '2025-02-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-02-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'Low', policyViolations: 3, dependencyCount: 1, tags: ['orphaned', 'secret', 'source-code', 'code-exposed'] },
  ...
  { id: 'ssh-s01', name: 'prod-analytics-ssh-key', type: 'SSH Key', commonName: 'analytics-01.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:An4xB2cDe...', owner: 'Unassigned', team: 'Data Engineering', application: 'Analytics Cluster', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2024-08-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-08-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 2, tags: ['suspicious', 'production'] },
  { id: 'ssh-s02', name: 'legacy-etl-deploy-key', type: 'SSH Key', commonName: 'etl-server-03.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Fk7yG3hIj...', owner: 'Unassigned', team: 'Data Engineering', application: 'ETL Pipeline', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2024-06-01', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-06-01', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['suspicious', 'legacy', 'production'] },
  { id: 'ssh-su01', name: 'shared-devteam-key', type: 'SSH Key', commonName: 'dev-shared-01.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Lm2nO4pQr...', owner: 'Dev Team', team: 'Platform Engineering', application: 'Shared Dev Environment', environment: 'Production', infrastructure: 'on-prem-dc1', discoverySource: 'SSH Host Scan', issueDate: '2024-03-15', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-03-15', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 8, tags: ['shared-user', 'production'] },
  { id: 'ssh-su02', name: 'ops-shared-access-key', type: 'SSH Key', commonName: 'ops-bastion-02.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:St5uV6wXy...', owner: 'IT Operations', team: 'IT Operations', application: 'Operations Tooling', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'Endpoint Agent', issueDate: '2024-05-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-05-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 5, tags: ['shared-user', 'ops'] },
  { id: 'ssh-r01', name: 'unknown-prod-key-4421', type: 'SSH Key', commonName: 'prod-web-04.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Za1bC2dEf...', owner: 'Unassigned', team: 'Unknown', application: 'Unknown', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2025-01-22', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-01-22', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 1, tags: ['rogue', 'production'] },
  { id: 'ssh-r02', name: 'untracked-key-7788', type: 'SSH Key', commonName: 'db-replica-02.internal', caIssuer: 'N/A', algorithm: 'Ed25519', keyLength: '256', serial: 'SHA256:Gh3iJ4kLm...', owner: 'Unassigned', team: 'Unknown', application: 'Unknown', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2024-11-08', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-11-08', autoRenewal: false, rotationFrequency: 'Never', status: 'Orphaned', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['rogue', 'production'] },
  { id: 'ssh-wu01', name: 'legacy-admin-rsa1024-key', type: 'SSH Key', commonName: 'legacy-admin-01.internal', caIssuer: 'N/A', algorithm: 'RSA-1024', keyLength: '1024', serial: 'SHA256:Np6oP7qRs...', owner: 'IT Operations', team: 'IT Operations', application: 'Legacy Admin Access', environment: 'Production', infrastructure: 'on-prem-dc1', discoverySource: 'SSH Host Scan', issueDate: '2020-06-01', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2020-06-01', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 3, tags: ['legacy', 'production', 'weak-user'] },
  { id: 'ssh-wu02', name: 'backup-user-key-dsa', type: 'SSH Key', commonName: 'backup-server-01.internal', caIssuer: 'N/A', algorithm: 'DSA', keyLength: '1024', serial: 'SHA256:Tu8vW9xYz...', owner: 'Infrastructure', team: 'Infrastructure', application: 'Backup System', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2019-03-15', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2019-03-15', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 2, tags: ['legacy', 'backup', 'weak-user'] },
  { id: 'ssh-wh01', name: 'legacy-host-key-rsa1024', type: 'SSH Key', commonName: 'legacy-db-02.internal', caIssuer: 'N/A', algorithm: 'RSA-1024', keyLength: '1024', serial: 'SHA256:Ab0cD1eF2...', owner: 'Database Operations', team: 'Database Operations', application: 'Legacy Database', environment: 'Production', infrastructure: 'on-prem-dc1', discoverySource: 'SSH Host Scan', issueDate: '2018-09-20', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2018-09-20', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 4, tags: ['host-key', 'legacy', 'production', 'weak-host'] },
  { id: 'ssh-wh02', name: 'old-fileserver-host-key', type: 'SSH Key', commonName: 'fileserver-01.internal', caIssuer: 'N/A', algorithm: 'DSA', keyLength: '1024', serial: 'SHA256:Gh3iJ4kLn...', owner: 'IT Operations', team: 'IT Operations', application: 'File Server', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2017-11-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2017-11-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 2, tags: ['host-key', 'legacy', 'weak-host'] },
  { id: 'ssh-m01', name: 'prod-key-on-staging-host', type: 'SSH Key', commonName: 'staging-web-01.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Mn5oP6qRt...', owner: 'Platform Engineering', team: 'Platform Engineering', application: 'Web Server', environment: 'Staging', infrastructure: 'azure-eastus-stg', discoverySource: 'SSH Host Scan', issueDate: '2025-08-14', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-08-14', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['misplaced', 'staging'] },
  { id: 'ssh-m02', name: 'payment-key-on-dev-host', type: 'SSH Key', commonName: 'dev-app-03.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Su8vW9xZa...', owner: 'Payments Engineering', team: 'Payments Engineering', application: 'Dev App Server', environment: 'Development', infrastructure: 'gcp-dev', discoverySource: 'SSH Host Scan', issueDate: '2025-10-22', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-10-22', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 1, tags: ['misplaced', 'development'] },
  { id: 'ssh-m03', name: 'hsm-key-on-app-server', type: 'SSH Key', commonName: 'app-server-07.internal', caIssuer: 'N/A', algorithm: 'Ed25519', keyLength: '256', serial: 'SHA256:Bc1dE2fGh...', owner: 'Security Team', team: 'Security Operations', application: 'App Server', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2025-12-01', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-12-01', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Low', policyViolations: 0, dependencyCount: 1, tags: ['misplaced', 'production'] },
  { id: 'ssh-sh01', name: 'shared-host-key-cluster-a', type: 'SSH Key', commonName: 'cluster-a-shared', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Ij4kL5mNo...', owner: 'Infrastructure', team: 'Infrastructure', application: 'Compute Cluster A', environment: 'Production', infrastructure: 'on-prem-dc1', discoverySource: 'SSH Host Scan', issueDate: '2024-02-28', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-02-28', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 6, tags: ['shared-host', 'production'] },
  { id: 'ssh-sh02', name: 'shared-host-key-dmz', type: 'SSH Key', commonName: 'dmz-proxy-shared', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Pq6rS7tUv...', owner: 'Infrastructure', team: 'Infrastructure', application: 'DMZ Proxy', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2024-07-15', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-07-15', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 4, tags: ['shared-host', 'production'] },
  { id: 'sec-h01', name: 'hardcoded-db-password-repo1', type: 'API Key / Secret', commonName: 'payments-db-conn-string', caIssuer: 'N/A', algorithm: 'AES-256-GCM', keyLength: '256', serial: 'GIT-SCN-2026-04-14-001', owner: 'Payments Engineering', team: 'Payments Engineering', application: 'Payment Gateway', environment: 'Production', infrastructure: 'github-payments-repo', discoverySource: 'Source Code Scan', issueDate: '2026-04-14', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2026-04-14', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 1, tags: ['hardcoded', 'code-exposed', 'source-code', 'payments'] },
  { id: 'sec-h02', name: 'stripe-key-in-config-file', type: 'API Key / Secret', commonName: 'stripe-live-key', caIssuer: 'N/A', algorithm: 'AES-256-GCM', keyLength: '256', serial: 'GIT-SCN-2026-04-14-002', owner: 'DevOps', team: 'DevOps', application: 'E-Commerce Frontend', environment: 'Production', infrastructure: 'github-frontend-repo', discoverySource: 'Source Code Scan', issueDate: '2026-04-14', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2026-04-14', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 1, tags: ['hardcoded', 'code-exposed', 'source-code'] },
  { id: 'sec-h03', name: 'sendgrid-api-key-hardcoded', type: 'API Key / Secret', commonName: 'sendgrid-notifications-key', caIssuer: 'N/A', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'GIT-SCN-2026-04-14-003', owner: 'Platform Engineering', team: 'Platform Engineering', application: 'Notification Service', environment: 'Production', infrastructure: 'github-platform-repo', discoverySource: 'Source Code Scan', issueDate: '2026-04-14', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2026-04-14', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['hardcoded', 'code-exposed', 'source-code'] },
  { id: 'sec-e01', name: 'twilio-auth-token-leaked', type: 'API Key / Secret', commonName: 'twilio-prod-auth', caIssuer: 'N/A', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'GIT-SCN-2026-03-22-008', owner: 'CX Engineering', team: 'Customer Experience', application: 'SMS Service', environment: 'Production', infrastructure: 'gitlab-cx-repo', discoverySource: 'Source Code Scan', issueDate: '2026-03-22', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2026-03-22', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['code-exposed', 'source-code'] },
  { id: 'ai-ns01', name: 'abandoned-nlp-agent', type: 'AI Agent Token', commonName: 'nlp-classify-agent', caIssuer: 'Internal Token Service', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'TOK-2025-11-01-044', owner: 'Unassigned', team: 'Unknown', application: 'NLP Classification', environment: 'Production', infrastructure: 'aws-lambda', discoverySource: 'API Gateway Scan', issueDate: '2025-11-01', expiryDate: '2026-05-01', daysToExpiry: 17, lastRotated: '2025-11-01', autoRenewal: false, rotationFrequency: '365 days', status: 'Active', pqcRisk: 'Medium', policyViolations: 0, dependencyCount: 2, tags: ['ai-agent', 'no-sponsor'], agentMeta: { agentType: 'Service Bot', framework: 'Hugging Face', servicesAccessed: ['S3 Data Lake', 'Internal API'], permissions: ['s3:GetObject', 'api:invoke'], permissionRisk: 'Right-sized', lastActivity: '3 days ago', actionsPerDay: 200 } },
  { id: 'ai-ns02', name: 'orphaned-summariser-agent', type: 'AI Agent Token', commonName: 'doc-summary-agent', caIssuer: 'Internal Token Service', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'TOK-2025-12-15-061', owner: 'Unassigned', team: 'Unknown', application: 'Document Summariser', environment: 'Production', infrastructure: 'gcp-cloud-run', discoverySource: 'MCP Registry', issueDate: '2025-12-15', expiryDate: '2026-06-15', daysToExpiry: 62, lastRotated: '2025-12-15', autoRenewal: false, rotationFrequency: '365 days', status: 'Active', pqcRisk: 'Low', policyViolations: 0, dependencyCount: 1, tags: ['ai-agent', 'no-sponsor'], agentMeta: { agentType: 'Service Bot', framework: 'LangChain', servicesAccessed: ['SharePoint', 'OpenAI API'], permissions: ['sharepoint:files.read', 'openai:chat.completions'], permissionRisk: 'Right-sized', lastActivity: '5 days ago', actionsPerDay: 80 } },
  { id: 'ai-nr01', name: 'legacy-integration-agent', type: 'AI Agent Token', commonName: 'legacy-erp-agent', caIssuer: 'Internal Token Service', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'TOK-2024-06-01-003', owner: 'IT Operations', team: 'IT Operations', application: 'ERP Integration', environment: 'Production', infrastructure: 'on-prem-dc1', discoverySource: 'Endpoint Agent', issueDate: '2024-06-01', expiryDate: '2027-06-01', daysToExpiry: 412, lastRotated: '2024-06-01', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Medium', policyViolations: 0, dependencyCount: 3, tags: ['ai-agent', 'legacy', 'no-rotation'], agentMeta: { agentType: 'Pipeline Agent', framework: 'Custom', servicesAccessed: ['SAP ERP', 'Internal DB', 'Email Service'], permissions: ['sap:read', 'db:select', 'email:send'], permissionRisk: 'Right-sized', lastActivity: '1 hour ago', actionsPerDay: 450 } },
  { id: 'ai-nr02', name: 'batch-reporting-agent', type: 'AI Agent Token', commonName: 'batch-report-agent', caIssuer: 'Azure AD', algorithm: 'JWT-RS256', keyLength: '2048', serial: 'AAD-APP-2024-0088', owner: 'Data Engineering', team: 'Data Engineering', application: 'Batch Reporting', environment: 'Production', infrastructure: 'azure-batch', discoverySource: 'Azure AD Connector', issueDate: '2024-09-10', expiryDate: '2027-09-10', daysToExpiry: 878, lastRotated: '2024-09-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Low', policyViolations: 0, dependencyCount: 4, tags: ['ai-agent', 'batch', 'no-rotation'], agentMeta: { agentType: 'Pipeline Agent', framework: 'Azure ML', servicesAccessed: ['Azure Blob', 'Power BI', 'SQL Database'], permissions: ['blob:read', 'powerbi:publish', 'sql:select'], permissionRisk: 'Minimal', lastActivity: '6 hours ago', actionsPerDay: 24 } },
  { id: 'ai-adm01', name: 'infra-automation-admin-agent', type: 'AI Agent Token', commonName: 'infra-admin-agent', caIssuer: 'Internal Token Service', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'TOK-2026-03-01-099', owner: 'Infrastructure', team: 'Infrastructure', application: 'Infrastructure Automation', environment: 'Production', infrastructure: 'aws-eks-prod', discoverySource: 'Endpoint Agent', issueDate: '2026-03-01', expiryDate: '2026-04-01', daysToExpiry: -13, lastRotated: '2026-03-01', autoRenewal: false, rotationFrequency: 'Never', status: 'Expired', pqcRisk: 'High', policyViolations: 0, dependencyCount: 8, tags: ['ai-agent', 'admin', 'production'], agentMeta: { agentType: 'Autonomous Agent', framework: 'Ansible + GPT-4', servicesAccessed: ['AWS EC2', 'AWS IAM', 'Terraform Cloud', 'PagerDuty', 'Slack'], permissions: ['ec2:*', 'iam:PassRole', 'terraform:apply', 'pagerduty:incidents.create', 'slack:chat.postMessage'], permissionRisk: 'Over-privileged', lastActivity: '14 days ago', actionsPerDay: 0 } }
];
