...
export interface CryptoAsset {
  id: string;
  name: string;
  type: 'TLS Certificate' | 'SSH Key' | 'SSH Certificate' | 'Code-Signing Certificate' | 'K8s Workload Cert' | 'Encryption Key' | 'API Key / Secret';
  commonName: string;
  caIssuer: string;
  algorithm: string;
  keyLength: string;
...
export const mockAssets: CryptoAsset[] = [
  ...
  { id: 'ssh-001', name: 'prod-db-01-authorized-key', type: 'SSH Key', commonName: 'prod-db-01.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:nThbg6kXUp...', owner: 'Unassigned', team: 'Database Operations', application: 'PostgreSQL Primary', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2025-06-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-06-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 2, dependencyCount: 1, tags: ['database', 'suspicious'], sshEndpoints: [{ host: 'prod-db-01.internal', ip: '10.2.14.55', port: 5432, role: 'host', lastSeen: '2026-04-14 08:12' }, { host: 'app-server-03.internal', ip: '10.2.14.20', port: 22, role: 'client', lastSeen: '2026-04-14 08:10' }, { host: 'bastion-01.acmecorp.com', ip: '52.14.88.201', port: 22, role: 'client', lastSeen: '2026-04-13 22:45' }] },
  ...
  { id: 'ssh-s01', name: 'prod-analytics-ssh-key', type: 'SSH Key', commonName: 'analytics-01.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:An4xB2cDe...', owner: 'Unassigned', team: 'Data Engineering', application: 'Analytics Cluster', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2024-08-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-08-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 2, tags: ['suspicious', 'production'] },
  { id: 'ssh-s02', name: 'legacy-etl-deploy-key', type: 'SSH Key', commonName: 'etl-server-03.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Fk7yG3hIj...', owner: 'Unassigned', team: 'Data Engineering', application: 'ETL Pipeline', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2024-06-01', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-06-01', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['suspicious', 'legacy', 'production'] },
  ...
  { id: 'ssh-r01', name: 'unknown-prod-key-4421', type: 'SSH Key', commonName: 'prod-web-04.internal', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Za1bC2dEf...', owner: 'Unassigned', team: 'Unknown', application: 'Unknown', environment: 'Production', infrastructure: 'aws-us-east-1-prod', discoverySource: 'SSH Host Scan', issueDate: '2025-01-22', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-01-22', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 0, dependencyCount: 1, tags: ['rogue', 'production'] },
  { id: 'ssh-r02', name: 'untracked-key-7788', type: 'SSH Key', commonName: 'db-replica-02.internal', caIssuer: 'N/A', algorithm: 'Ed25519', keyLength: '256', serial: 'SHA256:Gh3iJ4kLm...', owner: 'Unassigned', team: 'Unknown', application: 'Unknown', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'SSH Host Scan', issueDate: '2024-11-08', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2024-11-08', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'High', policyViolations: 0, dependencyCount: 1, tags: ['rogue', 'production'] },
