...
export const mockAssets: CryptoAsset[] = [
  ...
  { id: 'ssh-005', name: 'gitlab-deploy-key', type: 'SSH Key', commonName: 'gitlab-runner-01', caIssuer: 'N/A', algorithm: 'RSA-2048', keyLength: '2048', serial: 'SHA256:Wz4kL9pMnO...', owner: 'Unassigned', team: 'DevOps', application: 'GitLab CI', environment: 'Production', infrastructure: 'on-prem-dc2', discoverySource: 'Endpoint Agent', issueDate: '2025-03-15', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-03-15', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Critical', policyViolations: 3, dependencyCount: 2, tags: ['ci-cd', 'rogue'] },
  ...
  { id: 'secret-002', name: 'aws-iam-access-key-legacy', type: 'API Key / Secret', commonName: 'AKIA...EXAMPLE', caIssuer: 'AWS IAM', algorithm: 'HMAC-SHA256', keyLength: '256', serial: 'AKIAIOSFODNN7EXAMPLE', owner: 'Unassigned', team: 'IT Operations', application: 'Legacy Migration Tool', environment: 'Production', infrastructure: 'aws-iam', discoverySource: 'Source Code Scan', issueDate: '2025-02-10', expiryDate: 'N/A', daysToExpiry: -1, lastRotated: '2025-02-10', autoRenewal: false, rotationFrequency: 'Never', status: 'Active', pqcRisk: 'Low', policyViolations: 3, dependencyCount: 1, tags: ['secret', 'source-code', 'code-exposed'] },
