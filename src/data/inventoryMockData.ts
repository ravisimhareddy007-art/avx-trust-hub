...
export const mockITAssets: ITAsset[] = [
  { id: 'it-pay-01', name: 'payments-api.acmecorp.com', type: 'API Gateway', environment: 'Production', ownerTeam: 'Payments Engineering', cryptoObjectIds: ['cert-001', 'secret-001', 'ai-001'], riskScore: 91, criticalViolations: 3, policyCoverage: 60, lastSeen: '2026-04-14 09:15', managedBy: 'Terraform', infrastructure: 'aws-us-east-1-prod', application: 'Payments API' },
  ...
  { id: 'it-005', name: 'jenkins-ci.internal', type: 'CI/CD Pipeline', scanned: true, environment: 'Production', ownerTeam: 'DevOps', cryptoObjectIds: ['ssh-002', 'sshcert-001', 'secret-004', 'cs-001'], riskScore: 45, criticalViolations: 0, policyCoverage: 100, lastSeen: '2026-04-14 09:00', managedBy: 'Ansible', infrastructure: 'on-prem-dc1', application: 'Jenkins CI' },
  { id: 'it-006', name: 'cdn.acmecorp.com', type: 'CDN', scanned: true, environment: 'Production', ownerTeam: 'Infrastructure', cryptoObjectIds: ['cert-006', 'cert-003'], riskScore: 28, criticalViolations: 0, policyCoverage: 100, lastSeen: '2026-04-14 09:11', managedBy: 'Cloudflare', infrastructure: 'cloudflare-cdn', application: 'Content Delivery' },
  { id: 'it-007', name: 'eks-prod-cluster', type: 'K8s Cluster', scanned: true, environment: 'Production', ownerTeam: 'Platform Engineering', cryptoObjectIds: ['k8s-001', 'k8s-002', 'k8s-003', 'k8s-004', 'ssh-003', 'sshcert-002'], riskScore: 64, criticalViolations: 2, policyCoverage: 83, lastSeen: '2026-04-14 09:08', managedBy: 'Terraform', infrastructure: 'aws-eks-prod', application: 'EKS Production' },
  { id: 'it-008', name: 'auth.acmecorp.com', type: 'Web Server', scanned: true, environment: 'Production', ownerTeam: 'Identity & Access', cryptoObjectIds: ['cert-004'], riskScore: 35, criticalViolations: 0, policyCoverage: 100, lastSeen: '2026-04-14 09:07', managedBy: 'Kubernetes', infrastructure: 'gcp-us-central1', application: 'SSO Service' },
  ...
  { id: 'it-010', name: 'mail.acmecorp.com', type: 'Mail Server', scanned: true, environment: 'Production', ownerTeam: 'IT Operations', cryptoObjectIds: ['cert-009'], riskScore: 73, criticalViolations: 1, policyCoverage: 0, lastSeen: '2026-04-14 08:30', managedBy: 'Manual', infrastructure: 'on-prem-dc1', application: 'Email Server' },
  { id: 'it-011', name: 'legacy-erp.internal', type: 'Application Server', scanned: true, environment: 'Production', ownerTeam: 'IT Operations', cryptoObjectIds: ['cert-010'], riskScore: 91, criticalViolations: 2, policyCoverage: 0, lastSeen: '2026-04-14 07:00', managedBy: 'Manual', infrastructure: 'on-prem-dc2', application: 'Legacy ERP' },
